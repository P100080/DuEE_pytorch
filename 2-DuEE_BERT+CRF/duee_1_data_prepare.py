...
def data_process(path, model="trigger", is_predict=False):
    ...
    with open(path,encoding='utf-8') as f:
        for line in f:
            ...
            _id = d_json["id"]
            #print(d_json["text"].lower())
            text_a = ["，" if t == " " or t == "\ue627" or t =='\xa0' or t == "\u2003" or t == "\u2002" or t == "\u3000" or t == "\n" or t == "\u200b" or t == "\t" else t for t in list(d_json["text"].lower())]
...
if __name__ == "__main__":
    ...
    test_tri = data_process("{}/duee_test2.json".format(data_dir), "trigger")
    ...
    test_role = data_process("{}/duee_test2.json".format(data_dir), "role")
